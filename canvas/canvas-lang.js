...
var grammar = {
    ...
    {"name": "function_definition", "symbols": [{"literal":"function"}, "__", "identifier", "_", {"literal":"("}, "_", "parameter_list", "_", {"literal":")"}, "_", "code_block"], "postprocess": 
        d => ({
    ...
    {"name": "parameter_list", "symbols": ["parameter"], "postprocess": d => [d[0]]},
    {"name": "parameter_list", "symbols": ["parameter", "_", {"literal":","}, "_", "parameter_list"], "postprocess": 
        d => [d[0], ...d[4]]
                },
    ...
    {"name": "parameter", "symbols": ["identifier", "_", {"literal":":"}, "_", "identifier"], "postprocess": 
        d => ({
            name: d[0].value,
            type: d[4].value
        })
    ...
    {"name": "executable_statement", "symbols": ["line_category"], "postprocess": id},
    {"name": "executable_statement", "symbols": ["line_description"], "postprocess": id},
    ...
    {"name": "function_expression", "symbols": [{"literal":"function"}, "_", {"literal":"("}, "_", "parameter_list", "_", {"literal":")"}, "_", "code_block"], "postprocess": 
        d => ({
    ...
    {"name": "line_category", "symbols": [(lexer.has("category") ? {type: "category"} : category)], "postprocess": convertTokenId},
    {"name": "line_description", "symbols": [(lexer.has("description") ? {type: "description"} : description)], "postprocess": convertTokenId},
